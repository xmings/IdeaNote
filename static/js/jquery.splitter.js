                ...
                if (splitter_id !== null) {
                    ...
                    setTimeout(function () {
                        $('<div class="splitterMask"></div>')
                            .css('cursor', current_splitter.children().eq(1)
                                .css('cursor')).insertAfter(current_splitter);
                        ...
                        if (firstTime === 0) {
                            ...
                            if ((lastTime - firstTime) < 500) {
                                ...
                                if (current_splitter.position() < 50){
                                    ...
                                    lastDBClickPosition[splitter_id] = current_splitter.position();
                                    current_splitter.position(0);
                                }
                            }
                            firstTime = new Date().getTime();
                        }
