...
(function (document, window) {
    ...
    inlineAttachment.prototype.uploadFile = function (file) {
        ...
        if (typeof settings.staticParams === "object") {
            for (var key in settings.staticParams) {
                if (settings.staticParams.hasOwnProperty(key)) {
                    formData.append(key, settings.staticParams[key]);
                }
            }
        }

        if (typeof settings.dynamicParams === "object") {
            for (var k in settings.dynamicParams) {
                if (settings.dynamicParams.hasOwnProperty(k)) {
                    formData.append(k, eval(settings.dynamicParams[k]));
                }
            }
        }
